...
const checks = [
  ...
  [script.includes("palletState") && script.includes('state === "Completo"'), "El seleccionable diferencia pallets completos e incompletos."],
  [html.includes('data-hu344-mode="INCOMPLETE"') && html.includes('data-hu344-mode="MIXED"'), "La vista diferencia completar un pallet y crear un pallet mixto."],
  ...
  [css.includes(".hu344-base-picker") && css.includes(".hu344-mode-switch"), "Los selectores nuevos conservan el lenguaje visual móvil."],
